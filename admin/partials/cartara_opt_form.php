...
<div class="wrap wrap-data">
    <div class="head_wrap">
        <h1 class="cn_title dashicons-before dashicons-cloud">Cartara Forms</h1>
    </div>
    <div id="content">
        <h3 class="page_title">Shortcoder 
            <div class="cn_menu">
                <a href="<?php echo admin_url(); ?>admin.php?page=optform" class="button cn_back_btn">
                ...
                <div class="cn_name_wrap">
                    ...
                    <?php if (intval(isset($_GET['id'])) != '') { ?>
                        <div class="copy_shortcode">
                            Your shortcode is - 
                            <strong>
                                <?php echo '[cartara_opt_form id =' . intval($_GET['id']) . ']'; ?>
                            </strong>
                        </div>
                    <?php } else { ?>
