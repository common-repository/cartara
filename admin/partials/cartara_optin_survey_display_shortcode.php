...
<div class="wrap wrap-data">
    <div class="head_wrap">
        <h1 class="dashicons-before dashicons-cloud">Cartara Action Surveys</h1>
    </div>
    <div id="content">
        <h3 class="page_title">List of shortcodes created (<?php echo count($data); ?>)<span class="cn_menu">
                ...
                <a href="<?php echo admin_url(); ?>admin.php?page=cartara_survey_shortcoder" class="button button-primary cn_new_btn">
            ...
            if ($data != '') {
                foreach ($data as $data_val) {
                    ...
                    <li data-name= <?php echo $name; ?>  data-tags="">
                        <a href="<?php echo admin_url(); ?>admin.php?action=edit&id=<?php echo $id; ?>&page=cartara_survey_shortcoder" class="cn_link" title="Edit shortcode">
                            <?php echo $name; ?> 
                        </a>
                        <span class="cn_controls">
                            ...
                            <a href="javascript:void(0);" class="cn_delete" data-sname="<?php echo esc_html($data_val['formname']); ?>" data-id="<?php echo $id; ?>" title="Delete" onclick="cartara_survey_delete_form_code(<?php echo $id;?>);">
                            <span class="dashicons dashicons-trash "></span>
                            </a>
                        </span>
                        <input type="text" value="[cartara_survey_form id ='<?php echo $id; ?>']" class="cartara_copy_box" readonly="readonly" title="Copy shortcode" >
                    </li>
                    <?php
                }
            } else {
